...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    ...
    const sessdata = config.SESSION_ID.replace("/MAKAMESCO-MD<=>/g", '');
    try {
...
const port = process.env.PORT || 9090;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254769995625', '254756965035', '254739285768');
...
if (senderNumber.includes("254769995625") && !isReact) {
